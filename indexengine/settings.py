"""
Django settings for indexengine project.
...
PARSER_STOP_CHARS_FILENAME = os.path.join(BASE_DIR, "data/stop_chars.json")

with open(PARSER_STOP_CONTENT_FILENAME, "r") as f:
    PARSER_STOP_CONTENT = json.load(f)
...
SECRET_KEY = "django-insecure-h#l36isznh5s=!a1#8de1-w6m!6c=z-)92!ah%uw4%%c7@vy8@"
...
WSGI_APPLICATION = "indexengine.wsgi.application"
